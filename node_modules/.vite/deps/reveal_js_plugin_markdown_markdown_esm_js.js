...
}, N.Parser = O, N.parser = O.parse, N.Renderer = L, N.TextRenderer = C, N.Lexer = q, N.lexer = q.lex, N.Tokenizer = T, N.Slugger = Z, N.parse = N;
var D = "__SCRIPT_END__";
var P = /\[\s*((\d*):)?\s*([\s\d,|-]*)\]/;
var M = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" };
var markdown_esm_default = () => {
  ...
  function t2(e3) {
    ...
    t3 = t3.replace(new RegExp(D, "g"), "<\/script>");
  ...
  function n2(e3) {
    ...
    for (let e4 = 0, r3 = t3.length; e4 < r3; e4++) {
      const r4 = t3[e4].name, s3 = t3[e4].value;
      /data\-(markdown|separator|vertical|notes)/gi.test(r4) || (s3 ? n3.push(r4 + '="' + s3 + '"') : n3.push(r4));
    }
    return n3.join(" ");
  }
  function r2(t3) {
    const n3 = e2.getConfig().markdown;
    return (t3 = t3 || {}).separator = t3.separator || (null == n3 ? void 0 : n3.separator) || "\r?\n---\r?\n", t3.verticalSeparator = t3.verticalSeparator || (null == n3 ? void 0 : n3.verticalSeparator) || null, t3.notesSeparator = t3.notesSeparator || (null == n3 ? void 0 : n3.notesSeparator) || "^s*notes?:", t3.attributes = t3.attributes || "", t3;
  }
  function s2(e3, t3) {
    t3 = r2(t3);
  ...
  function i2(e3, t3) {
    ...
    let l3, a3, o3, c3 = 0, h2 = true, p2 = [];
    for (; l3 = n3.exec(e3); )
      a3 = i3.test(l3[0]), !a3 && h2 && p2.push([]), o3 = e3.substring(c3, l3.index), a3 && h2 ? p2.push(o3) : p2[p2.length - 1].push(o3), c3 = n3.lastIndex, h2 = a3;
    ...
    for (let e4 = 0, n4 = p2.length; e4 < n4; e4++)
      p2[e4] instanceof Array ? (u2 += "<section " + t3.attributes + ">", p2[e4].forEach(function(e5) {
        u2 += "<section data-markdown>" + s2(e5, t3) + "</section>";
      }), u2 += "</section>") : u2 += "<section " + t3.attributes + " data-markdown>" + s2(p2[e4], t3) + "</section>";
    return u2;
  }
  function l2(e3) {
      ...
      [].slice.call(e3.querySelectorAll("section[data-markdown]:not([data-markdown-parsed])")).forEach(function(e4, r4) {
        e4.getAttribute("data-markdown").length ? s3.push(function(e5) {
          return new Promise(function(t3, n3) {
            const r5 = new XMLHttpRequest(), s4 = e5.getAttribute("data-markdown"), i3 = e5.getAttribute("data-charset");
  ...
  function a2(e3, t3, n3) {
    const r3 = new RegExp(n3, "mg"), s3 = new RegExp('([^"= ]+?)="([^"]+?)"|(data-[^"= ]+?)(?=[" ])', "mg");
    let i3, l3, a3 = e3.nodeValue;
    if (i3 = r3.exec(a3)) {
      const n4 = i3[1];
      for (a3 = a3.substring(0, i3.index) + a3.substring(r3.lastIndex), e3.nodeValue = a3; l3 = s3.exec(n4); )
    ...
    if (null !== t3 && void 0 !== t3.childNodes && t3.childNodes.length > 0) {
      ...
      for (let i3 = 0; i3 < t3.childNodes.length; i3++) {
        ...
        if (i3 > 0) {
          let e4 = i3 - 1;
          for (; e4 >= 0; ) {
            const r4 = t3.childNodes[e4];
            if ("function" == typeof r4.setAttribute && "BR" !== r4.tagName) {
              n4 = r4;
              break;
            }
            e4 -= 1;
        ...
        let a3 = e3;
        "section" === l3.nodeName && (a3 = l3, n4 = l3), "function" != typeof l3.setAttribute && l3.nodeType !== Node.COMMENT_NODE || o2(a3, l3, n4, r3, s3);
      }
    }
    t3.nodeType === Node.COMMENT_NODE && false === a2(t3, n3, r3) && a2(t3, e3, s3);
  }
  function c2() {
    ...
    return [].slice.call(n3).forEach(function(e3) {
      ...
      const n4 = e3.querySelector("aside.notes"), r3 = t2(e3);
  ...
  return { id: "markdown", init: function(t3) {
    ...
    return n3 || (n3 = new N.Renderer(), n3.code = (e3, t4) => {
      ...
      if (P.test(t4)) {
        let e4 = t4.match(P)[2];
        e4 && (n4 = `data-ln-start-from="${e4.trim()}"`), r4 = t4.match(P)[3].trim(), r4 = `data-line-numbers="${r4}"`, t4 = t4.replace(P, "").trim();
      }
      return `<pre><code ${r4} ${n4} class="${t4}">${e3 = e3.replace(/([&<>'"])/g, (e4) => M[e4])}</code></pre>`;
